...
class EmployeeController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        if ($result) {
            ...
            $user->status = strtolower($employee->status);
            $user->role = 'user';
